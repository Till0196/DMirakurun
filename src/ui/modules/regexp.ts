...
/** Unicode 囲み文字 (四角形) */
export const squaredUnicode = /[\u{1F130}-\u{1F14E}\u{1F19B}-\u{1F1AC}\u{1F201}-\u{1F23B}]/ug;

/** Unicode 囲み文字 (属性用) */
export const enclosedAttributeUnicode = /[\u{1F14D}-\u{1F14E}\u{1F19B}-\u{1F1AC}\u{1F210}-\u{1F222}\u{1F23B}]/ug;
